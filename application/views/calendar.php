                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-primary add_calendar"> TAMBAH EVENT
                                    ...
                                    <div class="modal-content">
                                        <form class="form-horizontal" method="POST" action="POST" id="form_create">
                                            ...
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title" id="myModalLabel">Buat Kalender</h4>
                                          </div>
                                          <div class="modal-body">
                                           ...
                                           <div class="form-group">
                                            <label class="control-label col-sm-2">Judul Agenda <span class="required"> * </span></label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Tgl. Berakhir</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
